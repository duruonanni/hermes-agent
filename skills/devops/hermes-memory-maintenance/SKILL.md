...
| Signal | What to do |
|--------|------------|
| **Redundancy across files** — same fact in MEMORY.md AND USER.md (e.g., girlfriend info, formatting preferences) | Keep in MEMORY.md only — USER.md is for who the user IS, not for environment facts |
